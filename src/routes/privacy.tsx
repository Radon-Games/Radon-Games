...
function RouteComponent() {
  return (
    ...
    >
      ...
      <h3 className="mt-2 text-lg" id="1.a">
      ...
      <h3 className="mt-2 text-lg" id="2.a">
      ...
      <h3 className="mt-2 text-lg" id="2.b">
        b. Communication:
      </h3>
      <li className="font-normal tracking-wide">
      ...
      <h3 className="mt-2 text-lg" id="2.c">
        c. Personalization:
      </h3>
      <li className="font-normal tracking-wide">
      ...
      <h3 className="mt-2 text-lg" id="2.d">
        d. Legal Compliance:
      </h3>
      <li className="font-normal tracking-wide">
      ...
      <h2 className="mt-8 text-xl" id="3">
        3. Sharing of Information
      </h2>
      <p className="t font-normal tracking-wide">
        We do not sell or rent your personal information to third parties.
        However, we may share your information under the following
        circumstances:
      </p>

      <h3 className="mt-2 text-lg" id="3.a">
        a. Service Providers:
      </h3>
      <li className="font-normal tracking-wide">
      ...
      <h3 className="mt-2 text-lg" id="3.b">
      ...
      <h2 className="mt-8 text-xl" id="4">
        4. Security
      </h2>
      <p className="font-normal tracking-wide">
      ...
      <h2 className="mt-8 text-xl" id="5">
        5. Your Choices
      </h2>
      <p className="font-normal tracking-wide">
      ...
      <h3 className="mt-2 text-lg" id="5.a">
      ...
      <h3 className="mt-2 text-lg" id="5.b">
        b. Cookies:
      </h3>
      <li className="font-normal tracking-wide">
      ...
      <h3 className="mt-8 text-xl" id="7">
      ...
      <h2 className="mt-8 text-xl" id="8">
        8. Contact Us
      </h2>
      <p className="font-normal tracking-wide">
