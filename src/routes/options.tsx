...
export default function Options(): JSX.Element {
  ...
  return (
    <main>
      ...
      <section class="flex flex-col gap-5 w-full sm:px-16 md:px-20 lg:px-32">
        <div>
          ...
          <select
            ...
            id="tab-cloak"
            class="bg-gray-900 p-2 rounded-md border-solid border-2 border-gray-800 focus:outline-none"
          >
